...
final class updateAccredationApplication
{
    /**
     * @param  null  $_
     * @param  array{}  $args
    ...
    public function __invoke($_, array $args)
    {
        ...
        if(isset($args['id'])){
            $id = $args['id'];
            $cmeApp=AccredationApplication::find($id);
        }
        ...
        if(isset($args['status_id']))
            $cmeApp->status_id=$args['status_id'];
        ...
        if($file!=null){
            $cmeApp->sessions_upload = Storage::putFile('/accredation_applications/session_files',$args['sessions_upload']);
        }
        ...
        if(isset($args['finish']) && $args['finish']==1){
            $model_type = 'App\Models\AccredationApplication';
            $product=Product::where('link_product',5)->get();
          
            $cmePro=AccredationProduct::find($cmeApp->accredation_product_id);
