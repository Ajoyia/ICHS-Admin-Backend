...
final class Update
{
    ...
    {
        $cme_lecture = CMELecture::find($args['id']);
        if(isset($args['name'])){
        ...
        \DB::table('lecture_audio_visuals')->where('lecture_id', $cme_lecture->id)->delete();
        ...
        \DB::table('lecture_interactive_technologies')->where('lecture_id', $cme_lecture->id)->delete();
