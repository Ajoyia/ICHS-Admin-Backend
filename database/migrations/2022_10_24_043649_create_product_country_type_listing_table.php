...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('product_country_type_listing', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('cme_product_id')->unsigned()->nullable()->default(null);
    ...
    {
        Schema::dropIfExists('product_country_type_listing');
    }
};
