...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('static_pages_templates', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('template_id')->references('id')->on('html_templates')->onUpdate('set null')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('static_pages_templates');
    }
};
