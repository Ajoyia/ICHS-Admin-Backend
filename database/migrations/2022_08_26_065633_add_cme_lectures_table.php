...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('cme_lectures', function (Blueprint $table) {
            $table->id();
            ...
            $table->bigInteger('cme_session_id')->unsigned()->nullable()->default(null);
            ...
            $table->foreign('cme_session_id')->references('id')->on('cme_sessions')->onUpdate('set null')->onDelete('set null');
            $table->foreign('session_location_id')->references('id')->on('cme_locations')->onUpdate('set null')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('cme_lectures');
    }
};