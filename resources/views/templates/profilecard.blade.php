<main class="content__wrapper profile__listing__template">
    <section class="council__members__section  [ position-relative py-5 ]" :class="{ 'footer__membership__card__gap mb-4': !loggedIn }">
        <div class="container">
            <div class="row g-4">
            @foreach($data as $content )
                <div class="col-12 col-md-6 col-lg-4 col-xl-3 d-flex">
                    <div class="council__members__card">
                        ...
                        <div class="council__members__card__details"><h1>{{$content->name}}</h1>
                        <p>{{$content->detail}}</p>
                        </div>
                    </div>
                </div>
