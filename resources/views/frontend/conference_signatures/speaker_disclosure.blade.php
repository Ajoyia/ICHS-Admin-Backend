...
<head>
  ...
  <title>International Conference Activity Disclosure Form: Speaker</title>
  <!-- Web Fonts
         ======================= -->
  <style type="text/css">
    body {
          ...
          <tbody style="text-align: left; font-weight: 400;">
            <tr>
              <td colspan="2" style="padding: 15px 20px; text-align: left;">
                <h2 style="font-size: 26px; line-height: 32px; margin: 0; color: #01539D;">INTERNATIONAL CONFERENCE DISCLOSURE FORM: SPEAKERS</h2>
              </td>
            </tr>
                ...
                <table style="padding: 2px 20px 15px;">
                  <tr>
                    <td colspan="2" style="text-align: left; padding: 10px 0; line-height: 22px;">
                      ...
                      Is the financial relationships related to content of International Conference Scientific Program and Educational Activities?
